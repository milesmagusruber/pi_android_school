...
- Создать простое приложение наподобии того, с которым вы встречались в кодлабе. Приложение должно состоять из нескольких экранов: 
  ...
  - Задача "со звёздочкой": сделать на главном экране счетчик и отображать в нем количество раз которые пользователь возвращался в приложение (именно в приложение а не на экран)
  - Задача "с двумя звёздочками": всё задание должно быть выполнено с использованием языка Kotlin.
  
  Могу рекомендовать курс по Kotlin для тех, кто уже знаком с Java: https://www.udemy.com/kotlin-for-java-developers/
  Курс платный, но очень ёмкий, я сам по нему переходил с Java на Kotlin.
  Есть бесплатный https://www.udacity.com/course/kotlin-for-android-developers--ud888, но он расчитан на опытных разработчиков под Android, может подойти не всем.
